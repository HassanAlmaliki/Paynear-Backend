            ...
            ->components([
                \Filament\Schemas\Components\Section::make(__('messages.basic_info'))
                    ->schema([
                        ...
                        Infolists\Components\IconEntry::make('is_verified')->label(__('messages.is_verified'))->boolean(),
                ...
                \Filament\Schemas\Components\Section::make(__('messages.kyc_info'))
                    ->schema([
